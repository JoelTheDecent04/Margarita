...
{
	/*if (abs(sgSpaceGame->plPlayer->fX - fX) > 80.0f)
		fSpeedX = Game::sgSpaceGame->plPlayer->fX > fX ? 100.0f + sgSpaceGame->fDifficulty / 60.0f : -100.0f - sgSpaceGame->fDifficulty / 60.0f;
	else
	{
		fSpeedX = 0.0f;
